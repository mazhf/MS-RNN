...
class TrajGRU_cell(BaseConvRNN):
    ...
    def __init__(self, input_channel, num_filter, b_h_w, zoneout=0.0, L=cfg.TrajGRU_link_num,
                 i2h_kernel=(3, 3), i2h_stride=(1, 1), i2h_pad=(1, 1),
                 h2h_kernel=(5, 5), h2h_dilate=(1, 1),
                 act_type=RNN_ACT_TYPE):
...
class TrajGRU(nn.Module):
    def __init__(self, input_channel, output_channel, b_h_w):
        super().__init__()
        self.n_layers = cfg.LSTM_layers
        lstm = [TrajGRU_cell(input_channel, output_channel, b_h_w) for l in range(self.n_layers)]
