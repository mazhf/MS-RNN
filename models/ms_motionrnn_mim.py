...
class MotionRNN_cell(nn.Module):
    def __init__(self, input_channel, output_channel, b_h_w, kernel_size, stride, padding):
        ...
        print('This is Multi Scale MotionRNN-MIM!')
...
class Multi_Scale_MotionRNN_MIM(nn.Module):
    ...
    def __init__(self, input_channel, output_channel, b_h_w, kernel_size, stride, padding):
        ...
        B, H, W = b_h_w
        lstm = [MotionRNN_cell(input_channel, output_channel, [B, H, W], kernel_size, stride, padding),
                MotionRNN_cell(input_channel, output_channel, [B, H // 2, W // 2], kernel_size, stride, padding),
                MotionRNN_cell(input_channel, output_channel, [B, H // 4, W // 4], kernel_size, stride, padding),
                MotionRNN_cell(input_channel, output_channel, [B, H // 4, W // 4], kernel_size, stride, padding),
                MotionRNN_cell(input_channel, output_channel, [B, H // 2, W // 2], kernel_size, stride, padding),
                MotionRNN_cell(input_channel, output_channel, [B, H, W], kernel_size, stride, padding)]
