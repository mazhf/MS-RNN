...
class Evaluation(object):
    def __init__(self, seq_len, use_central=False, thresholds=None):
        ...
        self._thresholds = cfg.HKO.EVALUATION.THRESHOLDS if thresholds is None else thresholds
    ...
    def update(self, gt, pred):
        ...
        if cfg.dataset[0: 3] == 'HKO':
            bw = cfg.HKO.EVALUATION.BALANCING_WEIGHTS
        elif cfg.dataset[0: 3] == 'DWD':
            bw = cfg.DWD.EVALUATION.BALANCING_WEIGHTS
        else:
            bw = cfg.HKO.EVALUATION.BALANCING_WEIGHTS
